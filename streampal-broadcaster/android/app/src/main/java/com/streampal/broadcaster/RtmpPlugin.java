...
/**
 * RtmpPlugin
 * Capacitor bridge that launches StreamActivity and relays
 * stream events back to the web layer.
 */
...
public class RtmpPlugin extends Plugin {
    ...
    public void startStream(PluginCall call) {
        ...
        int    bitrate = call.getInt("bitrate", 1500 * 1024); // 1.5 Mbps default
    ...
    // ── Event receiver — relays native events to JS ───────────────────────────
